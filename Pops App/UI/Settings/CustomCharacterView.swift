...
class CustomCharacterView: UIView {
    ...
    func setupCircleBackgroud() {
        ...
        circleBackgroundView.heightAnchor.constraint(equalToConstant: 100).isActive = true
        circleBackgroundView.widthAnchor.constraint(equalToConstant: 100).isActive = true
        circleBackgroundView.layer.cornerRadius = 50
